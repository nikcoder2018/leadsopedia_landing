    ...
    <div class="container overflow-hidden">
        <div class="row">
            <div class="col-12 pt-5">
                <h1 data-aos="fade-right" data-aos-duration="1000">Privacy Policy</h1>
                <p data-aos="fade-right" data-aos-duration="1000">Last updated: November 27, 2020</p>
                <p data-aos="fade-right" data-aos-duration="1000">This Privacy Policy describes Our policies and procedures
                    ...
                    You.</p>
                <p data-aos="fade-right" data-aos-duration="1000">We use Your Personal data to provide and improve the
                    Service. By using the Service, You agree to the
                    collection and use of information in accordance with this Privacy Policy.</p>
                <h1 data-aos="fade-right" data-aos-duration="1000">Interpretation and Definitions</h1>
                <h2 data-aos="fade-right" data-aos-duration="1000">Interpretation</h2>
                <p data-aos="fade-right" data-aos-duration="1000">The words of which the initial letter is capitalized have
                ...
                <h2 data-aos="fade-right" data-aos-duration="1000">Definitions</h2>
                <p data-aos="fade-right" data-aos-duration="1000">For the purposes of this Privacy Policy:</p>
                <ul>
                    ...
                    <li data-aos="fade-right" data-aos-duration="1000">
                        <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;,
                            &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Leadsopedia, 1 Cupertino, CA
                            95014.</p>
                    </li>
                    <li data-aos="fade-right" data-aos-duration="1000">
                    ...
                    <li data-aos="fade-right" data-aos-duration="1000">
                        <p><strong>Website</strong> refers to Leadsopedia, accessible from <a
                                href="https://leadsopedia.com/" rel="external nofollow noopener"
                                target="_blank">https://leadsopedia.com/</a></p>
                    </li>
                    <li data-aos="fade-right" data-aos-duration="1000">
                ...
                <h1 data-aos="fade-right" data-aos-duration="1000">Collecting and Using Your Personal Data</h1>
                <h2 data-aos="fade-right" data-aos-duration="1000">Types of Data Collected</h2>
                <h3 data-aos="fade-right" data-aos-duration="1000">Personal Data</h3>
                <p data-aos="fade-right" data-aos-duration="1000">While using Our Service, We may ask You to provide Us with
                ...
                <h3 data-aos="fade-right" data-aos-duration="1000">Usage Data</h3>
                <p data-aos="fade-right" data-aos-duration="1000">Usage Data is collected automatically when using the
                    Service.</p>
                <p data-aos="fade-right" data-aos-duration="1000">Usage Data may include information such as Your Device's
                ...
                <p data-aos="fade-right" data-aos-duration="1000">When You access the Service by or through a mobile device,
                ...
                <p data-aos="fade-right" data-aos-duration="1000">We may also collect information that Your browser sends
                    whenever You visit our Service or when You access
                    the Service by or through a mobile device.</p>
                <h3 data-aos="fade-right" data-aos-duration="1000">Tracking Technologies and Cookies</h3>
                <p data-aos="fade-right" data-aos-duration="1000">We use Cookies and similar tracking technologies to track
                ...
                <ul>
                    <li data-aos="fade-right" data-aos-duration="1000"><strong>Cookies or Browser Cookies.</strong> A cookie
                    ...
                    <li data-aos="fade-right" data-aos-duration="1000"><strong>Web Beacons.</strong> Certain sections of our
                ...
                <p data-aos="fade-right" data-aos-duration="1000">Cookies can be &quot;Persistent&quot; or
                ...
                <p data-aos="fade-right" data-aos-duration="1000">We use both Session and Persistent Cookies for the
                    purposes set out below:</p>
                <ul>
                    <li>
                        <p data-aos="fade-right" data-aos-duration="1000"><strong>Necessary / Essential Cookies</strong></p>
                        <p data-aos="fade-right" data-aos-duration="1000">Type: Session Cookies</p>
                        <p data-aos="fade-right" data-aos-duration="1000">Administered by: Us</p>
                        <p data-aos="fade-right" data-aos-duration="1000">Purpose: These Cookies are essential to provide
                    ...
                    <li>
                        <p data-aos="fade-right" data-aos-duration="1000"><strong>Cookies Policy / Notice Acceptance
                                Cookies</strong></p>
                        <p data-aos="fade-right" data-aos-duration="1000">Type: Persistent Cookies</p>
                        <p data-aos="fade-right" data-aos-duration="1000">Administered by: Us</p>
                        <p data-aos="fade-right" data-aos-duration="1000">Purpose: These Cookies identify if users have
                            accepted the use of cookies on the Website.</p>
                    </li>
                    <li>
                        <p data-aos="fade-right" data-aos-duration="1000"><strong>Functionality Cookies</strong></p>
                        <p data-aos="fade-right" data-aos-duration="1000">Type: Persistent Cookies</p>
                        <p data-aos="fade-right" data-aos-duration="1000">Administered by: Us</p>
                        <p data-aos="fade-right" data-aos-duration="1000">Purpose: These Cookies allow us to remember
                ...
                <p data-aos="fade-right" data-aos-duration="1000">For more information about the cookies we use and your
                    choices regarding cookies, please visit our
                    Cookies Policy or the Cookies section of our Privacy Policy.</p>
                <h2 data-aos="fade-right" data-aos-duration="1000">Use of Your Personal Data</h2>
                <p data-aos="fade-right" data-aos-duration="1000">The Company may use Personal Data for the following
                    purposes:</p>
                <ul>
                    <li data-aos="fade-right" data-aos-duration="1000">
                ...
                <p data-aos="fade-right" data-aos-duration="1000">We may share Your personal information in the following
                    situations:</p>
                <ul>
                    <li data-aos="fade-right" data-aos-duration="1000"><strong>With Service Providers:</strong> We may share
                        Your personal information with Service
                        Providers to monitor and analyze the use of our Service, to contact You.</li>
                    <li data-aos="fade-right" data-aos-duration="1000"><strong>For business transfers:</strong> We may share
                        or transfer Your personal information in
                        connection with, or during negotiations of, any merger, sale of Company assets, financing, or
                        acquisition of all or a portion of Our business to another company.</li>
                    <li data-aos="fade-right" data-aos-duration="1000"><strong>With Affiliates:</strong> We may share Your
                        information with Our affiliates, in which case
                    ...
                    <li data-aos="fade-right" data-aos-duration="1000"><strong>With business partners:</strong> We may share
                        Your information with Our business partners to
                        offer You certain products, services or promotions.</li>
                    <li data-aos="fade-right" data-aos-duration="1000"><strong>With other users:</strong> when You share
                    ...
                    <li data-aos="fade-right" data-aos-duration="1000"><strong>With Your consent</strong>: We may disclose
                        Your personal information for any other purpose
                        with Your consent.</li>
                </ul>
                <h2 data-aos="fade-right" data-aos-duration="1000">Transfer of Your Personal Data</h2>
                <p data-aos="fade-right" data-aos-duration="1000">Your information, including Personal Data, is processed at
                    the Company's operating offices and in any
                    ...
                    jurisdiction.</p>
                <p data-aos="fade-right" data-aos-duration="1000">Your consent to this Privacy Policy followed by Your
                    submission of such information represents Your
                    agreement to that transfer.</p>
                <p data-aos="fade-right" data-aos-duration="1000">The Company will take all steps reasonably necessary to
                ...
                <h2 data-aos="fade-right" data-aos-duration="1000">Disclosure of Your Personal Data</h2>
                <h3 data-aos="fade-right" data-aos-duration="1000">Business Transactions</h3>
                <p data-aos="fade-right" data-aos-duration="1000">If the Company is involved in a merger, acquisition or
                    ...
                    Privacy Policy.</p>
                <h2 data-aos="fade-right" data-aos-duration="1000">Security of Your Personal Data</h2>
                <p data-aos="fade-right" data-aos-duration="1000">The security of Your Personal Data is important to Us, but
                    remember that no method of transmission over
                    the Internet, or method of electronic storage is 100% secure. While We strive to use commercially
                    acceptable means to protect Your Personal Data, We cannot guarantee its absolute security.</p>
                <h1 data-aos="fade-right" data-aos-duration="1000">Links to Other Websites</h1>
                <p data-aos="fade-right" data-aos-duration="1000">Our Service may contain links to other websites that are
                    not operated by Us. If You click on a third
                    party link, You will be directed to that third party's site. We strongly advise You to review the
                    Privacy Policy of every site You visit.</p>
                <p data-aos="fade-right" data-aos-duration="1000">We have no control over and assume no responsibility for
                ...
                <p data-aos="fade-right" data-aos-duration="1000">If you have any questions about this Privacy Policy, You
                    can contact us:</p>
                <ul>
                    <li data-aos="fade-right" data-aos-duration="1000">
                    ...
                    <li data-aos="fade-right" data-aos-duration="1000">
                        <p>By phone number: support@leadsopedia.com</p>
                    </li>
                </ul>
            </div>
        </div>
