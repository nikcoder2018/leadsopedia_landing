            ...
            @if(count($subscription_plans) > 0)
                ...
                <div class="pricing-single shadow text-center" style="border-radius: 1rem;">
                    ...
                    <div class="pricing-price">
                        ...
                        <a href="{{env('APP_FRONT_URL')}}/register" class=" btn btn-secondary">Select</a>
                        </div>
...
<div class="text-center">
                <div class="card rounded shadow">
                    <div class="card-body" style="width: 50rem;">
                        ...
                        <form class="enterprise-form" action="{{route('enterprise.request')}}" method="POST">
                            @csrf
                            <div class="form-row">
                            <div class="col">
...
@section('js')
    <script>
        ...
        $('.enterprise-form').on('submit', function(e){
                e.preventDefault();
                $('.enterprise-form').find('button[type=submit]').prop('disabled', true);
                $.ajax({
                    ...
                    success: function(resp){
                        if(resp.success){
                            $('.enterprise-form').find('button[type=submit]').prop('disabled', false);
                            $('.enterprise-form').find('.message-container').html(`
